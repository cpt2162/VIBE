# Generated by Django 3.1.7 on 2021-08-29 00:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.CharField(default='*Unknown*', max_length=20)),
                ('caption', models.TextField()),
                ('photo', models.ImageField(upload_to='posts/')),
                ('queues', models.PositiveIntegerField(default=0, editable=False)),
                ('date_created', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('liked_users', models.ManyToManyField(editable=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('song', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='social.post')),
